...
from app.lib.es_utils import rewrite_match_queries, rewrite_terms_for_data_collection, compose_rewrites
...
def search_data_collections(body: Optional[Dict[str, Any]] = Body(None)) -> Dict[str, Any]:
    return run_search(
        ...
        rewrite=compose_rewrites(rewrite_match_queries, rewrite_terms_for_data_collection)
    )